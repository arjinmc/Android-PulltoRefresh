 ...
 */
public class StatusModeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mPtrRecyclerView.setLoadingView(new DefaultLoadingLayout(this));
        mPtrRecyclerView.setEmptyView(new DefaultEmptyLayout(this));

        //error layout
        mLayoutError = (LinearLayout) LayoutInflater.from(this).inflate(R.layout.layout_status_error, null);
        mBtnRetry = mLayoutError.findViewById(R.id.btn_retry);
        ...
        mPtrRecyclerView.setErrorView(mLayoutError);
