 ...
 * Created by Eminem Lo on 2018/6/21.
 * email: arjinmc@hotmail.com
 */
public class MaterialDesignHeadView extends PullLayout {

    private MaterialDrawable mMaterialDrawable;

    public MaterialDesignHeadView(@NonNull Context context) {
        super(context);
        init();
    }

    public MaterialDesignHeadView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MaterialDesignHeadView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public MaterialDesignHeadView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init() {
        ...
        mMaterialDrawable = new MaterialDrawable(getContext());
        ImageView imageView = new ImageView(getContext());
        imageView.setImageDrawable(mMaterialDrawable);
//        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(FrameLayout.LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(LayoutParams.MATCH_PARENT, 200);
    ...
    private class MaterialDrawable extends Drawable implements Animatable {
        private final Interpolator LINEAR_INTERPOLATOR = new LinearInterpolator();
        private final Interpolator END_CURVE_INTERPOLATOR = new EndCurveInterpolator();
        private final Interpolator START_CURVE_INTERPOLATOR = new StartCurveInterpolator();
        private final Interpolator EASE_INTERPOLATOR = new AccelerateDecelerateInterpolator();
        ...
        public MaterialDrawable(Context context) {
...
//            mTop = -mDiameter - (getRefreshLayout().getFinalOffset() - mDiameter) / 2;
        ...
        public void draw(Canvas c) {
            ...
            Log.e("bounds", bounds.left + "/" + bounds.top + "/" + bounds.right + "/" + bounds.bottom);
